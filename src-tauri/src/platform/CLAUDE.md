...
- 本目录只封装 OS、进程、路径、权限、窗口、通知、shell/no-console、daemon/task/launchd 等能力。
- platform 返回结构化能力结果，不保存账号、relay、MCP、skills 等业务状态。
- 不解释产品状态机，不把单平台行为写成通用事实。
