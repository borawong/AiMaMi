...
- 本目录必须覆盖 IPC DTO、状态竞争、事件重放和失败态合同。
- happy path 不能作为状态架构验收。
- 新增 command 或 DTO 时必须补齐 stale、delayed、failure、concurrency、cancel、abort 和 event replay 场景。
