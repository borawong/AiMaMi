# custom-instructions feature Claude 执行规则
...
## custom-instructions feature owner

- 本目录是 custom-instructions 复杂模块的唯一 feature owner。
...
- 无 raw/internal 证据支撑的 custom-instructions 行为只能保留中文职责注释、边界类型、测试占位和待补证据位置。
