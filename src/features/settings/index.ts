...
Frontend module: features/settings/index
...
*/
 export { SettingsPage as SettingsFeature, type SettingsPageProps as SettingsFeatureProps } from '@/components/settings/settings-page';
