# tray-shell feature Claude 执行规则
...
## tray-shell feature owner

- 本目录是 tray-shell 复杂模块的唯一 feature owner。
...
- 无 raw/internal 证据支撑的 tray-shell 行为只能保留中文职责注释、边界类型、测试占位和待补证据位置。
