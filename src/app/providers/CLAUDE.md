...
- 全局 Provider 统一聚合 Locale、Theme、Query、auth/bootstrap seed、toast/modal/context host、runtime bridge 和开发辅助。
- Provider 只建立上下文，不读取模块私有数据、不渲染业务页面、不在模块切换时重建 QueryClient。
- 新增 Provider 必须说明全局生命周期和下游消费边界。
