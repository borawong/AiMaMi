# daemon-autoswitch 路由目录 Claude 执行规则
...
- 具体业务还原必须进入 src/features/daemon-autoswitch、src/components/daemon-autoswitch、src/services/daemon-autoswitch、src/store/daemon-autoswitch 和模块 cache/tests。
