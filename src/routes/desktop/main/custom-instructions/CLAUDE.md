# custom-instructions 路由目录 Claude 执行规则
...
- 具体业务还原必须进入 src/features/custom-instructions、src/components/custom-instructions、src/services/custom-instructions、src/store/custom-instructions 和模块 cache/tests。
