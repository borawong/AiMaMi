...
- route、layout、error boundary、meta、visibility、redirect、preload、skeleton 和 fill-height 统一归 route registry 或 navigation registry。
- sidebar、header、tray 和页面 title 只消费同一份 route meta。
- 页面文件只负责路由参数、页面骨架、布局装配和模块入口挂载。
