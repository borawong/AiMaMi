...
Frontend module: config/index
This file is a structured reconstruction scaffold, not recovered original source.
*/
export const FRONTEND_MODULE_ARCHITECTURE = 'app/routes/features/components/services/store/hooks/utils/types/config/locales/libs/layout/contracts/mocks/restoration' as const;
