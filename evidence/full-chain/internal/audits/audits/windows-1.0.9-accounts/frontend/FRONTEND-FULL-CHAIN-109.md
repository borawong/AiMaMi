# Frontend Full Chain - AiMaMi 1.0.9 Windows accounts

Scope: additive frontend/current-source archive consumer chain for the already accepted Windows accounts IDA closure. This file does not promote or change gate state.
