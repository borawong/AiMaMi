# Frontend Consumer Chain 109 - MCP (windows)
...
Raw leaves remain under `<source-location>/raw/aimami/1.0.9/windows/mcp/<command>/`. Use those leaves for owner/threading/interface/error/side-effect facts; use this file for current source archive frontend consumer wiring.
