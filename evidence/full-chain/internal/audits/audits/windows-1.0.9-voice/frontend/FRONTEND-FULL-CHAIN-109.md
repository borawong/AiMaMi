# Frontend Full Chain - AiMaMi 1.0.9 Windows voice

Scope: additive frontend/current-source archive consumer chain for the accepted Windows voice absence-substitute package. This file does not change gate state.
