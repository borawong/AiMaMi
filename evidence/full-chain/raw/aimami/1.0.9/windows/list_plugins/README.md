# AiMaMi 1.0.9 Windows list_plugins

Scope: list_plugins only. Platform evidence is Windows same-platform PE static evidence against the canonical binary SOT.
