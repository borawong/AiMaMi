...
evidence_root: <source-location>/raw/aimami/1.0.9/windows/list_plugins
intermediate_root: <source-location>/intermediate/aimami/1.0.9/windows/list_plugins
handoff_root: <source-location>/aimami/1.0.9/windows-x64/list_plugins
product: aimami
version: 1.0.9
platform: windows / windows-x64 handoff
leaf: list_plugins
kind: read/list plugin registry command
